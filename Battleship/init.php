...
Autoloader::register('Battleship/App/Validator/Rules/IsCorrectOrientation');
Autoloader::register('Battleship/App/Validator/Rules/IsNoShipsIntersection');
...
Autoloader::register('Battleship/App/Validator/Request/BaseShipPlacementRequest');
Autoloader::register('Battleship/App/Validator/Request/PlaceShipRequest');
Autoloader::register('Battleship/App/Validator/Request/RemoveShipRequest');
Autoloader::register('Battleship/App/Validator/Request/PlaceOneShipRequest');
